...
<div class="event-form-when" id="em-form-when">
	...
	<p class="em-time-range">
		<span class="em-event-text"><?php _e('Work starts at','events-manager'); ?></span>
	...
	<?php _e( 'This doctor works every day between the beginning and end date, with start/end times applying to each day.', 'events-manager'); ?>
	</span>
</div>  
