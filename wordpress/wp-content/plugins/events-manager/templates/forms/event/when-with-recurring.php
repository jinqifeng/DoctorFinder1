...
<div id="em-form-with-recurrence" class="event-form-with-recurrence event-form-when">
	<p><?php _e('He/She is recurly working.', 'events-manager'); ?> <input type="checkbox" id="em-recurrence-checkbox" name="recurring" value="1" <?php if($EM_Event->is_recurring()) echo 'checked' ?> /></p>
	...
	<div class="em-recurring-text">
		...
		<p class="em-duration-range">
			<?php echo sprintf(__('Each work spans %s day(s)','events-manager'), '<input id="end-days" type="text" size="8" maxlength="8" name="recurrence_days" value="'. $EM_Event->recurrence_days .'" />'); ?>
		</p>
