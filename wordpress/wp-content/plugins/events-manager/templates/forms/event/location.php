...
<div class="em-location-data-nolocation">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB207oN4bNI4t6gWWj5xV7l-vc6TTdsNOk&callback=initMap"
            async defer></script>
</div>
<?php endif; ?>
<div id="em-location-data" class="em-location-data">
	...
	<table class="em-location-data">
		...
		<tr class="em-location-data-name">
			<th><?php _e ( 'Institution Name:', 'events-manager')?></th>
			<td>
				...
				<br />
				<em id="em-location-search-tip"><?php esc_html_e( 'Create a Institution or start typing to search a previously created Institution.', 'events-manager')?></em>
				<em id="em-location-reset" style="display:none;"><?php esc_html_e('You cannot edit saved Institution here.', 'events-manager'); ?> <a href="#"><?php esc_html_e('Reset this form to create a institution or search again.', 'events-manager')?></a></em>
			</td>
 		</tr>
