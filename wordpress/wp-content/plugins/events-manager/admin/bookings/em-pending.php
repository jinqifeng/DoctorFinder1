				...
				<table id='dbem-bookings-table' class='widefat post '>
					<thead>
						<tr>
							...
							<th class='manage-column' scope="col"><?php _e('Doctor', 'events-manager'); ?></th>
							<?php endif; ?>
							...
							if( ($rowno < $limit || empty($limit)) && ($event_count >= $offset || $offset === 0) ) {
								...
								<tr>
									...
									<!--	<span class="trash"><a class="em-bookings-delete" href="<?php echo $delete_url ?>"><?php _e('Delete','events-manager'); ?></a></span> |
										<a class="em-bookings-edit" href="<?php echo EM_ADMIN_URL; ?>&amp;page=events-manager-bookings&amp;booking_id=<?php echo $EM_Booking->booking_id; ?>"><?php _e('Edit/View','events-manager'); ?></a> by jwn -->
									</td>
								</tr>
								<?php
							}
