		...
		foreach($placeholders[1] as $key => $result) {
			...
			switch( $result ){
				...
				case '#_LOCATIONPAGEURL': //Depricated
					...
					//$replace = ($result == '#_LOCATIONURL' || $result == '#_LOCATIONPAGEURL') ? $link : '<a href="'.$link.'">'.esc_html($this->location_name).'</a>'; by jwn
                    $replace = ($result == '#_LOCATIONURL' || $result == '#_LOCATIONPAGEURL') ? $link : '<a>'.esc_html($this->location_name).'</a>';
