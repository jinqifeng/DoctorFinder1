...
function em_add_options() {
	...
	$dbem_options = array(
		...
		'dbem_search_form_categories_label' => __('All Service','events-manager'),
		'dbem_search_form_category_label' => __('Service','events-manager'),
    ...
    <thead>
        <tr>
			...
			<th class="event-description" scope="col">'.__('Doctor','events-manager').'</th>
		</tr>
   	</thead>
    <tbody>',
...
{has_location}
<p>
	<strong>'.__('Institution','events-manager').'</strong><br/>
	#_LOCATIONLINK
</p>
{/has_location}
<p>
...
<p>#_LOCATIONNEXTEVENTS</p>',
		...
		'dbem_bookings_tax_auto_add' => 0, //adjust prices to show tax?
			...
			'dbem_bookings_form_msg_closed' => __('Bookings are closed for this time .','events-manager'),
