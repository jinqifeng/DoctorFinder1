<?php
    ...
    add_filter('um_add_user_frontend_filter', 'um_add_user_frontend_filter', 10);
	function um_add_user_frontend_filter($args){
        global $ultimatemember;
        ...
        do_action('um_after_new_user_register_my', $user_id, $args);
    ...
    add_action('um_after_new_user_register_my', 'um_after_new_user_register_my', 10, 2);
    function um_after_new_user_register_my( $user_id, $args ){
    ...
    add_action('um_post_registration_my', 'um_post_registration_my', 10, 2);
    function um_post_registration_my( $user_id, $args ){
        global $ultimatemember;
        unset(  $args['user_id'] );
        extract($args);
